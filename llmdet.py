...
def run_inference(model, processor, image_path, text_prompt, box_threshold=0.35, text_threshold=0.25, output_dir="output_llmdet"):
    """
    이미지에 대해 LLMDet 추론을 실행하고 결과를 저장합니다.
